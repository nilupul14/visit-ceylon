...
const CinematicTeaser = () => {
  const [currentTeaser, setCurrentTeaser] = useState(dummyTrailers[2]);

  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden">
      <p className="text-gray-300 font-medium text-lg max-w-[960px] mx-auto">
        Cinematic Teasers: Into the Island of Wonders – Experience the Magic of
        Sri Lanka through Our Captivating Movie Trailers
      </p>

      <div className="relative mt-6">
        <BlurCircle top="-100px" right="-100px" />
        <ReactPlayer
          url={currentTeaser.videoUrl}
          controls={false}
      ...
      <div className="group grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto">
        {dummyTrailers.map((teaser) => (
          <div
            ...
            onClick={() => setCurrentTeaser(teaser)}
          >
            <img
              src={teaser.image}
              alt="trailer"
